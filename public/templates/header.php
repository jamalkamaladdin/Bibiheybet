...
function bb_frontend_header(array $options = []): void
{
    ...
    $extraMenuLabels = [
        'az' => ['prayer' => 'Namaz vaxtları', 'quran' => 'Quran dinlə', 'search' => 'Axtarış...'],
        'en' => ['prayer' => 'Prayer Times',   'quran' => 'Listen Quran', 'search' => 'Search...'],
        'ru' => ['prayer' => 'Время намаза',    'quran' => 'Слушать Коран', 'search' => 'Поиск...'],
        'ar' => ['prayer' => 'أوقات الصلاة',    'quran' => 'استمع للقرآن', 'search' => 'بحث...'],
        'fa' => ['prayer' => 'اوقات نماز',      'quran' => 'قرآن بشنوید', 'search' => 'جستجو...'],
    ];
...
<?php endif; ?>
    ...
    <!-- Overlay (arxa fon) -->
    <div class="bb-menu-overlay" id="bbMenuOverlay"></div>

    <!-- Hamburger menyu paneli (half-screen slide-in) -->
    <aside class="bb-mobile-menu" id="bbMobileMenu" aria-hidden="true">
        <div class="bb-mobile-menu-inner">
            <!-- Üst hissə: logo + bağla düyməsi -->
            <div class="bb-mobile-menu-header">
                <a href="<?= bb_lang_url('', $lang) ?>" class="bb-mobile-menu-logo" aria-label="<?= bb_sanitize(SITE_NAME) ?>">
            ...
            <!-- Alt hissə: dil + sosial -->
            <div class="bb-mobile-menu-footer">
