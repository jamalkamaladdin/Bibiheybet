    ...
    <header class="bb-hero-header" id="bbHeader" data-header-type="hero">
        ...
        <div class="bb-hero-content">
            ...
            <nav class="bb-hero-nav" aria-label="Əsas naviqasiya">
                ...
                <div class="bb-hero-lang" id="bbLangSwitch">
            ...
            <!-- Başlıq -->
            <h1 class="bb-hero-title">Bibiheybət məscid-ziyarətgah kompleksi</h1>

            <!-- Məscid illustrasiyası -->
            <div class="bb-hero-mosque">
                <img src="/public/assets/img/bibiheybet3d.png" alt="Bibiheybət Məscidi">
            </div>
        </div>
    </header>
<?php
