...
function bb_frontend_footer(array $options = []): void
{
    ...
    $footerStrings = [
        ...
        'address' => [
            'az' => 'Bibiheybət şossesi, Bakı, Azərbaycan',
            'en' => 'Bibiheybat highway, Baku, Azerbaijan',
            'ru' => 'Шоссе Бибиэйбат, Баку, Азербайджан',
            'ar' => 'طريق بيبي حيبات، باكو، أذربيجان',
            'fa' => 'بزرگراه بی‌بی حیبات، باکو، آذربایجان',
        ],
        'follow_us' => [
            'az' => 'Bizi izləyin',
            'en' => 'Follow us',
    ...
    $ft = function (string $key) use ($footerStrings, $lang): string {
        return $footerStrings[$key][$lang] ?? $footerStrings[$key]['az'] ?? '';
    };
...
?>
    ...
    <footer class="bb-footer">
        <div class="bb-footer-ornament" aria-hidden="true">
        ...
        <div class="bb-footer-inner bb-container">
            ...
            <div class="bb-footer-grid">
                ...
                <div class="bb-footer-nav">
                    <h4 class="bb-footer-heading"><?= bb_sanitize($ft('nav_title')) ?></h4>
                    <ul class="bb-footer-links">
                        <?php foreach ($menuItems as $item): ?>
                            ...
                            ?>
                        <li><a href="<?= bb_sanitize($menuUrl) ?>"><?= bb_sanitize($item['label']) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                ...
                <div class="bb-footer-contact">
                    <h4 class="bb-footer-heading"><?= bb_sanitize($ft('contact_title')) ?></h4>
                    <div class="bb-footer-address">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" class="bb-footer-icon">
                            <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                        </svg>
                        <span><?= bb_sanitize($ft('address')) ?></span>
                    </div>

                    <div class="bb-footer-social">
                        <span class="bb-footer-social-label"><?= bb_sanitize($ft('follow_us')) ?></span>
                        <div class="bb-footer-social-links">
                            <a href="https://www.instagram.com/bibiheybetziyaretgahi/" target="_blank" rel="noopener" aria-label="Instagram" class="bb-footer-social-btn">
                            ...
                            <a href="https://www.facebook.com/bibiheybetmecidi/" target="_blank" rel="noopener" aria-label="Facebook" class="bb-footer-social-btn">
            ...
            <div class="bb-footer-bottom">
                ...
                <p class="bb-footer-copyright">
                    &copy; <?= $year ?> <?= bb_sanitize(SITE_NAME) ?>. <?= bb_sanitize($ft('rights')) ?>
                </p>
            </div>
        </div>
    </footer>
