        ...
        if (empty($errors)) {
            $stmt = $db->prepare("
                UPDATE pilgrimages SET
                    slug_az = :slug_az, slug_en = :slug_en, slug_ru = :slug_ru,
                    name_az = :name_az, name_en = :name_en, name_ru = :name_ru,
