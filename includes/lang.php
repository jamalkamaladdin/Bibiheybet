...
$bb_route_map = [
    ...
    'ar' => [
        ...
        'search'            => 'bahth',
        'xanim-haqqinda'    => 'an-al-sayyida-hakima',
        'xanim'             => 'sayyida-hakima',
    ],
    'fa' => [
        'articles'          => 'maqalat-fa',
        'article'           => 'maqale-fa',
...
function bb_lang_switch_url(string $targetLang): string
{
    ...
    // Siyahı səhifələri (articles, pilgrimages, xanim-haqqinda)
    if (in_array($routeName, ['articles', 'pilgrimages', 'xanim-haqqinda'])) {
